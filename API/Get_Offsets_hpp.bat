...
set "TempVers=%TEMP%\rblx_vers_%RANDOM%.hpp"
...
if "%choice%"=="1" set "TargetVer=%CurrentVersion%"&set "TargetFile=Internal_Offsets.hpp"&goto :fetch
if "%choice%"=="2" set "TargetVer=%CurrentVersion%"&set "TargetFile=External_Offsets.hpp"&goto :fetch
if "%choice%"=="3" set "TargetVer=%CurrentVersion%"&set "TargetFile=FFlags.hpp"&goto :fetch
if "%choice%"=="4" set "TargetVer=%FutureVersion%"&set "TargetFile=Internal_Offsets.hpp"&goto :fetch
if "%choice%"=="5" set "TargetVer=%FutureVersion%"&set "TargetFile=External_Offsets.hpp"&goto :fetch
if "%choice%"=="6" set "TargetVer=%FutureVersion%"&set "TargetFile=FFlags.hpp"&goto :fetch
if "%choice%"=="7" set "TargetFile=Internal_Offsets.hpp"&goto :detect_your
if "%choice%"=="8" set "TargetFile=External_Offsets.hpp"&goto :detect_your
if "%choice%"=="9" set "TargetFile=FFlags.hpp"&goto :detect_your
...
:detect_your
set "TempPath=%TEMP%\rblx_path_%RANDOM%.hpp"
