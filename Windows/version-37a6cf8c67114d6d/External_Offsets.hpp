...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-37a6cf8c67114d6d";
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x8ca9b88;
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t AutomaticScalingEnabled = 0xe5;
         ...
         inline constexpr uintptr_t PlatformStatePointer = 0x5b7b98b8;
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x8a44c18;
    }
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x82e1d88;
